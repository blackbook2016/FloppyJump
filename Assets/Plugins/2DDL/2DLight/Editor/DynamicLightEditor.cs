	...
	public override void OnInspectorGUI () {
		...
		EditorGUI.BeginChangeCheck();
		{
			...
			if(fRange < 360f){
				...
				EditorGUILayout.IntSlider(segments, 5, 200, new GUIContent("Segments","Quantity of line segments is used for build mesh render of 2DLight. 5 at least in spot Lights"));
			}else{
